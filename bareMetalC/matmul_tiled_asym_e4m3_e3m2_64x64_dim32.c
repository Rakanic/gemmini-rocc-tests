// Asymmetric FP8_E4M3-act x FP8/FP6_E3M2-wei 64x64 matmul, BF16 output. Both operands via LUT.
// Per-operand altfmt: rs1[6]=0 (act E4M3); rs1[31]=weight_altfmt_diff -> weight altfmt = 0 XOR 0 = 0 = E3M2. out_mx_fmt=3.
#include <stdint.h>
#include <stdio.h>
#include <string.h>
...
#include "include/matmul_data_asym_e4m3_e3m2_dim32.h"

#define TILE 16
#define DIM 32
#define VALUES_PER_BYTE 2
#define USE_LUT 1
#define MX_ALTFMT 0                 // config_ex rs1[6]: activation altfmt (E4M3)
...
int main() {
  ...
  // config_ex: A (act) = E4M3, fp6/E3M2 (wgt), per-operand altfmt via rs1[6]/rs1[31],
  ...
  ROCC_INSTRUCTION_RS1_RS2(XCUSTOM_ACC,
    ...
    | ((uint64_t)(1) << 12)         // B (weight) format = fp6 (code1); wgt altfmt=0 -> E3M2
  ...
  if (errors == 0) printf("e4m3xe3m2 asym WS matmul test PASSED (no mismatches).\n");
  else             printf("e4m3xe3m2 asym WS matmul test FAILED with %d mismatches.\n", errors);
  return errors == 0 ? 0 : 1;
}
