...
#include "include/matmul_fp8_128x128_dim8.h"
...
int main() {
  ...
  int SPAD_DEST = tiles_I * tiles_K * DIM;   // clear the A footprint (dim8 64x64 = 512)
  ...
  // are full-width (DIM FP8/row), NOT chunked like the acc path. Byte mapping verified in sim.
  gemmini_fence();
