// FP8 E4M3-quad (via LUT) 64x128x128 matmul, REQUANT output — DIM=32 (32x32 mesh), MxDim32AllGemminiRocketConfig.
// DIM=32 port of matmul_tiled_fp8_e4m3_lut_64x128x128_requant.c. Changes vs the DIM=16 original:
...
#include "include/matmul_data_mx_lut_e4m3_64x128x128_dim32.h"
