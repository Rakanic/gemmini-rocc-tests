// FP8 E5M2 (via LUT) 128x128 matmul, REQUANT output — DIM=32 (32x32 mesh), MxDim32AllGemminiRocketConfig.
// DIM=32 port of matmul_tiled_fp8_e5m2_128x128_requant.c, same structure as the e4m3-lut dim32 requant test
...
#include "include/matmul_data_mx_lut_e5m2_128x128_dim32.h"
