...
ACT_SPEC = "fp6:e3m2"     # FP6_E3M2 activation (LUT)
WEI_SPEC = "fp8:e4m3"     # FP8_E4M3 weight (LUT)
SCALE_SPEC = "fpe8m0"
LUT_INDEX_BITS = 4
...
A_TILE_M = 32
K_TILE   = 16
HEADER   = os.environ.get("ASYM_HEADER_PATH", "./include/matmul_data_asym_e3m2_e4m3.h")
