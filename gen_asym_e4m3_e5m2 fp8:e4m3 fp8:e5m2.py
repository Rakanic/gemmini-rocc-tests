...
ACT_SPEC = "fp8:e5m2"     # FP8 E5M2 activation (LUT, 8-bit codebook)
WEI_SPEC = "fp6:e3m2"     # FP6 E3M2 weight (LUT, 6-bit codebook)
SCALE_SPEC = "fpe8m0"
LUT_INDEX_BITS = 4
...
A_TILE_M = 32
K_TILE   = 16
HEADER   = os.environ.get("ASYM_HEADER_PATH", "./include/matmul_data_asym_e5m2_e3m2.h")
