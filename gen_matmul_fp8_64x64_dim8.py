...
def main() -> None:
    ...
    hdr = HERE / "include" / "matmul_fp8_64x64_dim8.h"
...
#ifndef INCLUDE_MATMUL_FP8_64X64_DIM8_H
#define INCLUDE_MATMUL_FP8_64X64_DIM8_H
...
#endif // INCLUDE_MATMUL_FP8_64X64_DIM8_H
""")
    print(f"wrote {hdr}")
