...
python golden_model.py --input fp8:e4m3 --input-rounding zero --prod-mant-bits 7 --acc bf16 --acc-rounding q_bf16_rne --scaled-spec bf16 --scale-spec fpe8m0 --scale-exp 2 --M 64 --K 64 --N 64 --tile 16 --header-path include/matmul_data_mx_fp8.h
